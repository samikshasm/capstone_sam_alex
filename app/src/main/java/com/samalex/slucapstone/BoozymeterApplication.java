...
//    public static final long IN_EPISODE_REMINDER_INTERVAL = 15 * 1000;   // 15 secconds
...
//    public static final long IN_EPISODE_REMINDER_INTERVAL = 30 * 60 * 1000; // 30 minutes
    ...
    // Weekend test settings (08/20/2019)
//    public static final long CYCLE_OFFSET = 4 * 60 * 60 * 1000;     //  4-hour offset to force 12pm (noon) start of cycle #1
//    public static final long CYCLE_LENGTH = 8 * 60 * 60 * 1000;    //  8-hour cycles
//    public static final int NUM_CYCLES = 9;
//    public static final long SURVEY_OFFSET = 510 * 60 * 1000;  //  8 hours and 30 minutes beyond offset start
//    public static final long EVENING_REMINDER_OFFSET = 3 * 60 * 60 * 1000;    // 3 hours after offset start
//    public static final long IN_EPISODE_REMINDER_INTERVAL = 30 * 60 * 1000;   // 30 minutes

        // Pre-Official settings
//    public static final long CYCLE_OFFSET = 5 * 60 * 60 * 1000; // 5 hours (from start of natural cycle)
//    public static final long CYCLE_LENGTH = 24 * 60 * 60 * 1000; // 1 day
//    public static final int NUM_CYCLES = 3; // 3 cycles
//    public static final long SURVEY_OFFSET = 27 * 60 * 60 * 1000; // 8 am (27 hours from user start time that includes CYCLE_OFFSET)
//    public static final long EVENING_REMINDER_OFFSET = 13 * 60 * 60 * 1000; // 6pm (13 hours from user start time that includes CYCLE_OFFSET)
//    public static final long IN_EPISODE_REMINDER_INTERVAL = 30 * 60 * 1000; // 30 minutes
    ...
    public static long getNextEveningRemonderTimeInMillis(long userStartTime, int currentCycle) {
        return userStartTime + (currentCycle * BoozymeterApplication.CYCLE_LENGTH) + BoozymeterApplication.EVENING_REMINDER_OFFSET;
    }
}
