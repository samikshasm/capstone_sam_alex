...
//    final public static long SURVEY_OFFSET = 8 * 60 * 60 * 1000; // 8 hours (from start of natural cycle)
//    final public static long EVENING_REMINDER_OFFSET = 18 * 60 * 60 * 1000; // 18 hours (from start of natural cycle)
...
//    final public static int NUM_INTERVENTION = 3;
