...
//    public static final long IN_EPISODE_REMINDER_INTERVAL = 30 * 60 * 1000; // 30 minutes
    ...
    // Testing settings
//    public static final long CYCLE_OFFSET = 1 * 60 * 1000;    // 1 mins
//    public static final long CYCLE_LENGTH = 10 * 1000;    //  20 mins
//    public static final int NUM_CYCLES = 3;
//    public static final long SURVEY_OFFSET = 25 * 60 * 1000;  //  25 mins after cycle start
//    public static final long EVENING_REMINDER_OFFSET = 10 * 1000;    // 12 mins from cycle time which is 3 hours from cycle offset start
//    public static final long IN_EPISODE_REMINDER_INTERVAL = 2 * 60 * 1000;   // 2 mins
